...
library(robustbase)
library(pheatmap)
setwd('/mnt/data0/noah/analysis/misc-analysis-local/ORCA/polymer_sims/MYC/3D_simulation/new_comparison/run2')
...
pdf('Granta519_MYC_simulation_randomLoading_Weak-EBF1-Block.pdf')
