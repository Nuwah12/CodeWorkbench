...
library(robustbase)
library(pheatmap)
setwd('/mnt/data0/noah/analysis/misc-analysis-local/ORCA/polymer_sims/MYC/3D_simulation/new_comparison/run1')
...
pdf('Granta519_MYC_simulation_randomLoading_WT-EBF1-Block.pdf')
