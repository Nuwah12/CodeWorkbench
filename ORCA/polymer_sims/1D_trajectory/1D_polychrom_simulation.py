...
E2_blockingRegion = np.arange(304+front_buffer, 312+front_buffer) # E2, EBF1 involved (15, MED)
#B3_blockingRegion_forward = np.arange(553+front_buffer, 570+front_buffer) # B3+, EBF1 involved (8, WEAK)
...
blockingRegions = {'E1_1':E1_blockingRegion_1, 'E1_2':E1_blockingRegion_2, 'E2':E2_blockingRegion, 'B3-': B3_blockingRegion_reverse, 'MYC':MYC_blockingRegion}
#blockingRegions = {'E1_1':E1_blockingRegion_1, 'E1_2':E1_blockingRegion_2, 'B3-':B3_blockingRegion_reverse, 'MYC':MYC_blockingRegion}
...
wholePolymer_loading = [0, N1-1+end_buffer] # Entire polymer
