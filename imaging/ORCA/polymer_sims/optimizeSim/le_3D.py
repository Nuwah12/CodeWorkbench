...
def le_threeD(out_dir):
    ### Gather parameters from the 1D portion
    trajectories = h5py.File("trajectory/LEFPositions.h5") # Saved trajectories from 1D siumulation
    ...
    reporter = HDF5Reporter(folder=f"{out_dir}/sim_outs", # Save data location
